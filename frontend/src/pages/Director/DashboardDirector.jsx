...
export default function DashboardDirector() {
  const { id = 'ISC' } = useParams(); // ID de la carrera (ej. ISC)
  const { token } = useAuth();
  ...
  return (
    <div className="p-8 bg-gray-50/50 min-h-full">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900">Ingeniería en Sistemas Computacionales</h2>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-gray-100">
            {grupos.map(g => {
              const total = g.total_estudiantes || 1; // Evitar división por 0
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-100 text-center">
          <Link to={`/carreras/${id}/riesgo-agregado`} className="text-sm font-semibold text-eduPurple hover:underline">
